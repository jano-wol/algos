...
TEST(DisjointSetUnionCompress, TestDisjointSetUnionCompress)
{
  ...
  testSizesDisjointSetUnionCompress(1, {{0, 0}, {0, 0}}, 0, 0);
  testSizesDisjointSetUnionCompress(2, {}, 0, 0);
  testSizesDisjointSetUnionCompress(2, {}, 1, 1);
  testSizesDisjointSetUnionCompress(2, {{0, 1}, {1, 1}}, 0, 1);
  testSizesDisjointSetUnionCompress(2, {{0, 1}, {1, 1}}, 1, 1);
  testSizesDisjointSetUnionCompress(2, {{0, 1}}, 0, 1);
  testSizesDisjointSetUnionCompress(2, {{0, 1}, {0, 1}}, 1, 1);
  testSizesDisjointSetUnionCompress(7, {{0, 2}, {1, 2}, {2, 3}, {4, 3}, {5, 4}, {6, 4}}, 0, 3);
  testSizesDisjointSetUnionCompress(7, {{0, 2}, {1, 2}, {2, 3}, {4, 3}, {5, 4}, {6, 4}}, 1, 3);
  testSizesDisjointSetUnionCompress(7, {{0, 2}, {1, 2}, {2, 3}, {4, 3}, {5, 4}, {6, 4}}, 2, 3);
  testSizesDisjointSetUnionCompress(7, {{0, 2}, {1, 2}, {2, 3}, {4, 3}, {5, 4}, {6, 4}}, 3, 3);
  testSizesDisjointSetUnionCompress(7, {{0, 2}, {1, 2}, {2, 3}, {4, 3}, {5, 4}, {6, 4}}, 5, 3);
  testSizesDisjointSetUnionCompress(7, {{0, 2}, {1, 2}, {2, 3}, {4, 3}, {5, 4}, {6, 4}}, 6, 3);
  testSizesDisjointSetUnionCompress(9, {{0, 2}, {1, 2}, {2, 3}, {4, 3}, {5, 4}, {6, 4}, {7, 8}}, 7, 8);
}