...
TEST(RangeModeQuery, TestRangeModeQuery)
{
  ...
  testExpected(std::vector<int>{7, 6, 7, 6, 7, 6, 7}, {{0, 2}, {1, 3}, {2, 4}, {3, 5}, {4, 6}}, {7, 6, 7, 6, 7});
  testExpected(std::vector<int>{7, 6, 7, 6, 7, 6, 7}, {{0, 3}, {1, 4}, {2, 5}, {3, 6}}, {6, 6, 6, 6});
  testExpected(std::vector<int>{7, 6, 7, 6, 7, 6, 7}, {{0, 6}, {1, 6}, {0, 5}, {1, 5}}, {7, 6, 6, 6});
  testExpected(std::vector<int>{7, 6, 7, 6, 7, 6, 7}, {{0, 0}, {1, 1}, {2, 2}, {3, 3}, {1, 5}}, {7, 6, 7, 6, 6});
  testExpected(std::vector<size_t>{7, 6, 7, 6, 7, 6, 7}, {{0, 6}}, {7});
  testExpected(std::vector<size_t>{7, 6, 7, 6, 7, 6, 7, 8, 8, 8, 8, 8},
               {{0, 6}, {0, 7}, {0, 8}, {0, 9}, {0, 10}, {0, 11}}, {7, 7, 7, 7, 7, 8});
  testExpected(std::vector<size_t>{8, 8, 8, 8, 8, 7, 6, 7, 6, 7, 6, 7},
               {{0, 11}, {1, 11}, {2, 11}, {3, 11}, {4, 11}, {5, 11}}, {8, 7, 7, 7, 7, 7});
  testExpected(std::vector<size_t>{4, 3, 2, 1}, {{0, 3}, {1, 2}}, {1, 2});
}
